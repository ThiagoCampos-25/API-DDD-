...
builder.Services.AddSingleton(typeof(IGeneric<>), typeof(RepositoryGeneris<>));
...
builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
    .AddJwtBearer(option =>
    {
        ...
        option.Events = new JwtBearerEvents 
        {
            ...
            {
                Console.WriteLine("OnAuthenticationFailed: " + context.SecurityToken);
                return Task.CompletedTask;
            }
        };
...
//var urlHomolog = "https://dominiodocliente2.com.br";
//var urlProducao = "https://dominiodocliente3.com.br";
